namespace Productos {
    ...
    class PrecioFechaP:PrecioFecha {
        ...
        public PrecioFechaP(System.DateTime f_Inicio, double precio) : base(f_Inicio,precio) {
            Aumenta(15);
        }
    }
    /// <summary>
    ...
    class PrecioFechaNP : PrecioFecha {
        ...
        /// <param name="f_Inicio">Fecha de inicio de tiempo límite</param>
        /// <param name="precio">Precio de arranque</param>
        public PrecioFechaNP(System.DateTime f_Inicio, double precio) : base(f_Inicio, precio) {
            Aumenta(365);
        }
    }
}
