...
public class Funciones {
    /// <summary>
        ...
        /// <param name="nombre">Ingresa el nombre del icono de la ventana, colocar en el archivo de recursos</param>
    public static void Diseno(Form Lienzo,int x,int y,String Titulo,String nombre) {
        Lienzo.Size = new Size(x, y);
        ComponentResourceManager imgs = new ComponentResourceManager(typeof(Pinta_Figuras.recursos));
